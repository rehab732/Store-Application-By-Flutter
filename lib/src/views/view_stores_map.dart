...
class ViewStoresOnMap extends StatefulWidget{
  @override
  _ViewStoresOnMap createState() => _ViewStoresOnMap();
}

class _ViewStoresOnMap extends State<ViewStoresOnMap> {
  GoogleMapController mapController; //contrller for Google map
  final Set<Stores> stores = new Set(); //markers for google map
